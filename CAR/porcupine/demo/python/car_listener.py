        ...
        try:
            ...
            while True:
                ...
                if num_keywords == 1 and result:
                    ...
                    if result == 0:  # hey autobot
                        r = requests.post(target_url, data=json.dumps(data0), headers=headers)
                    elif result == 1: # i will drive now
                        r = requests.post(target_url, data=json.dumps(data1), headers=headers)
                    elif result == 2: # drive for me
                        r = requests.post(target_url, data=json.dumps(data2), headers=headers)
